...
public class AdminMessAdapter extends RecyclerView.Adapter<AdminMessAdapter.ViewHolderMess> {

    private List<String> nodeNames;
    private Context mess_context;

    // Constructor
    public AdminMessAdapter(List<String> nodeNames, Context mess_context) {
    ...
    @NonNull
    @Override
    public AdminMessAdapter.ViewHolderMess onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate the custom item layout (admin_mess_look.xml)
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_mess_look, parent, false);
        return new AdminMessAdapter.ViewHolderMess(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminMessAdapter.ViewHolderMess holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mess_context, AdminMessSingleActivity.class);
