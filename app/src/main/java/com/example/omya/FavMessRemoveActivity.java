...
public class FavMessRemoveActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> requestCallPermission = registerForActivityResult(
            ...
            isGranted -> {
                if (isGranted) {
                    ...
                    Toast.makeText(FavMessRemoveActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                }
            }
    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_mess_remove);
        ...
        dialButton.setOnClickListener(v -> {
            ...
            if (ActivityCompat.checkSelfPermission(FavMessRemoveActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (key != null && !key.isEmpty()) {
                    ...
                    DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("doormint/fav/"+modEmail+"/mess/").child(key);
...
//                    Toast.makeText(SingleOwnerRoomActivity.this, databaseRef, Toast.LENGTH_SHORT).show();
                    ...
                    databaseRef.removeValue().addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(FavMessRemoveActivity.this, "Room Remove successfully!", Toast.LENGTH_SHORT).show();
                            finish(); // Close activity after deletion
                        } else {
                            Toast.makeText(FavMessRemoveActivity.this, "Failed to delete room!", Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(FavMessRemoveActivity.this, "Invalid key, deletion failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void makeCall() {
        ...
        if (!phoneNumber.isEmpty()) {
            ...
            Toast.makeText(FavMessRemoveActivity.this, "Phone number is not available", Toast.LENGTH_SHORT).show();
        }
    }
...
//            Toast.makeText(roomContext, "User not logged in!", Toast.LENGTH_SHORT).show();
        ...
        database.getReference().child("doormint/fav/"+modEmail+"/mess").push().setValue(model)
                .addOnSuccessListener(unused -> {
                    Toast.makeText(FavMessRemoveActivity.this, "Upload successful!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                })
                .addOnFailureListener(e -> {
                    dialog.dismiss();
                    Toast.makeText(FavMessRemoveActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
