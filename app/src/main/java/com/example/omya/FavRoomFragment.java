...
public class FavRoomFragment extends Fragment {

    private ArrayList<RoomModel> recycleList;
    private RecyclerView recyclerView;
    private FirebaseDatabase firebaseDatabase;
    private RoomFavAdapter recycleAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recycleAdapter = new RoomFavAdapter(recycleList, getContext());
...
//            Toast.makeText(roomContext, "User not logged in!", Toast.LENGTH_SHORT).show();
        ...
        firebaseDatabase.getReference().child("doormint/fav/" + modEmail + "/room").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
