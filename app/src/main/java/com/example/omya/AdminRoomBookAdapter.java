...
public class AdminRoomBookAdapter extends RecyclerView.Adapter<AdminRoomBookAdapter.ViewHolderRoom>{
    private ArrayList<RoomModel> roomList;
    private Context roomContext;

    public AdminRoomBookAdapter(ArrayList<RoomModel> roomList, Context roomContext) {
...
//        String modEmail = email.replace(".", "_");
        ...
        if (email != null) {
            ...
            DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("doormint/book/");

            // Set click listener for each item
            holder.itemView.setOnClickListener(v -> {
                Intent intent = new Intent(roomContext, AdminRoomRemoveActivity.class);
